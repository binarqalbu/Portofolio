    ...
    ?>
            ...
            <div class=" bg-list d-flex flex-column align-items-left fw-bold gap-2 mt-4">
                <ul class="d-flex flex-column list-unstyled">
                    ...
                    <li class="h7 <?php if($page=='selling'){echo 'active';}?>"><a class=" nav-link text-dark" href="selling"><i
                                class="fal fa-bars me-2"></i> <span>Selling</span></a></li>
                    <li class="h7 <?php if($page=='buying'){echo 'active';}?>"><a class=" nav-link text-dark" href="buyinglist"><i
                                class="fal fa-bars me-2"></i> <span>Buying</span></a></li>
                    <li class="h7 <?php if($page=='invoice'){echo 'active';}?>"><a class=" nav-link text-dark" href="invoice"><i
                                class="fal fa-bars me-2"></i> <span>Invoice</span></a></li>
                </ul>
