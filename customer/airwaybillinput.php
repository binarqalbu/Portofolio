...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `airwaybill`(`courier`,`shipper`, `consignee`, `country`, `destination`, `address`, `contact`, `postcode`, `telephone`, 
    `pieces`, `weight`, `volume`, `value_invoice`, `service_request`, `details_of_shipment`, `type_of_payment`, 
    `description_of_good`, `special_instruction`) VALUES ('$courier','$shipper','$consignee','$country','$destination','$address','$contact',
    ...
    if($result){
      header('location:http://localhost/Raf/customer/airwaybillsearch');
    }else{
      ...
      <div class="container-fluid px">
        ...
        <form action ="" method="post">
          <div class="form-group">
              <div class="col-sm-7">
                  <input type="text" id="shipper" name="shipper" value="<?php echo $shipper;?>" hidden="hidden" required/>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-7">
