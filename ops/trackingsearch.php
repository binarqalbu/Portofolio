                ...
                <?php include 'database' . '.php'; 
                          ...
                          if($result){
                            while($row=mysqli_fetch_assoc($result)){
                              ...
                              echo'<td>'.$detail.'</td>';
                              echo'<td>';
                              echo'<button type="button" class="btn btn-primary btn-sm"><a href="trackinginput?inputid='.$raf_id.'" style="text-decoration:none;" class="text-light">Update</a></button>';
                              ...
                              echo'<button type="button" class ="btn btn-success btn-sm"><a href="trackingdone?doneid='.$raf_id.'" style="text-decoration:none;" onclick="javascript:confirmationDelete($(this));return false;" class="text-light">Done</a></button>';
                              echo'</td>'; 
                              echo'</tr>';
