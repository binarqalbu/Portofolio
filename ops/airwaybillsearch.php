                ...
                <?php include 'database' . '.php'; 
                  ...
                  if($result){
                    while($row=mysqli_fetch_assoc($result)){
                      ...
                      echo'<button type="button" class ="btn btn-danger btn-sm"><a href="airwaybilldelete?deleteid='.$id.'" onclick="javascript:confirmationDelete($(this));return false;" style="text-decoration:none;" class="text-light">Delete</a></button>';
                      echo'<button type="button" class ="btn btn-dark btn-sm"><a href="airwaybillprint?printid='.$id.'" target="_blank" style="text-decoration:none;" class="text-light">&nbsp &nbsp &nbsp &nbsp &nbsp Print &nbsp &nbsp &nbsp &nbsp &nbsp</a></button>';
                      echo'</td>'; 
                      echo'</tr>';
