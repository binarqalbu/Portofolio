<?php
        ...
        //   }
        //   else{
        //     header("location:index?error=password not found");
        //   }
      // }?>
...
<div class="sign-up bg-white mt-2 h-auto mb-2 text-center pt-4 pb-3 pe-4 ps-4 d-flex flex-column">
        ...
        <form method="POST" id="signup" action="createaccout" onsubmit="return validateInput();">
          ...
          <p class="mt-4">you have account? <a href="index">sign-in</a></p>
        </form>
     </div>
